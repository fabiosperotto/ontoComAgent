...
###Usando ontoComAgent
Instancie o objeto da classe Mediator nas formas seguintes e utilize seus métodos para retornar uma string com as informações pesquisadas. Existe um conjunto de códigos que tipificam a origem das mensagems dos agentes (veja último parâmetro dos construtores):

- 0: Repassado mensagem do agente diretamente na String agentMessage:

`Mediator med = new Mediator("Local/archive/ontology.owl",URIOntologia,agetMessage,0);`
`System.out.println(med.getKnowledge());`

- 1: Informando o caminho onde se encontra o arquivo com a mensagem em KQML:

`Mediator med = new Mediator("Local/archive/ontology.owl",URIOntologia,"Local/message.txt",1);`
`System.out.println(med.getKnowledge());`
...
#### ontoComAgent com [Jade](http://jade.tilab.com/) e Eclipse
//soon
